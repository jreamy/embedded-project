...
"""
Defines various data representations. Currently defines:
 - Hand position data in the Hand class and subclasses
     contianing finger and joint positions.
"""

class Hand():
    """
    Class for holding hand position data.
    """
...
class finger():
    """
    Class that indexes the finger of a hand.
    """
...
class joint():
    """
    Class that indexes a join of a hand.
    """
